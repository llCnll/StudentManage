					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<table cellspacing=0 cellpadding=5  border=0>
							...
							<tr>
								...
								<input class=button id=download type=button value="下载模板" onclick="javascript:location.href='${pageContext.request.contextPath }/download?method=download&fileName=StudentTest.xlsx';">
								</td>
							</tr>
						</table>
					</TD>
